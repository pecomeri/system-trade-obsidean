...
- 出力: `results/family_C_m1entry/C002/`

## 結果（DataviewでCSV参照）

```dataviewjs
const paths = {
  verify_m: "results/family_C_m1entry/C002/in_sample_2024/monthly.csv",
  forward_m: "results/family_C_m1entry/C002/forward_2025/monthly.csv",
  forward_ms: "results/family_C_m1entry/C002/forward_2025/monthly_by_session.csv",
};
...
理由：W1は条件差分として検討できるが、C001の基盤は価値なしとみえる